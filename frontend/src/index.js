...
function renderPlayGame(data) {
  ...
  rulesA.innerHTML =
    "The object of this game is to guess which of the two food items has the most calories. After every correct answer, two more food items appear.<br>This will go on until you select the incorrect answer in which the game is over.<h3><b>Good Luck!<b></h3>";
  rulesDiv.appendChild(rulesA);

  const playAgain = document.createElement("button");
  playAgain.className = "massive ui button";
  playAgain.style = "width: 250px; margin: 100px;";
  playAgain.innerText = "Play Now!";
...
function gameOver() {
  ...
  loseGif.src =
    "http://giphygifs.s3.amazonaws.com/media/DXFzuOpPXvUiI/giphy.gif";
